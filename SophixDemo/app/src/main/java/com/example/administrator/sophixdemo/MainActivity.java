...
import static com.example.administrator.sophixdemo.MainActivity.CALENDAR_CODE;
import static com.example.administrator.sophixdemo.MainActivity.LOCATION_CODE;
import static com.example.administrator.sophixdemo.MainActivity.SENSORS_CODE;
...
public class MainActivity extends AppCompatActivity {
                ...
                Permissions4M.get(MainActivity.this)
                        ...
                        .requestListener(new ListenerWrapper.PermissionRequestListener() {
                            ...
                            public void permissionGranted(int code) {
                                Log.i("MainActivity.clss", "读取通讯录权限成功 in activity with listener");
                            }

                            @Override
                            public void permissionDenied(int code) {
                                Log.i("MainActivity.clss", "读取通讯录权失败 in activity with listener");
                            }

                            @Override
                            public void permissionRationale(int code) {
                                Log.i("MainActivity.clss", "请打开读取通讯录权限 in activity with listener");
                            }
                        })
                        .requestPageType(Permissions4M.PageType.MANAGER_PAGE)
    ...
    public void syncGranted(int code) {
        switch (code) {
            case LOCATION_CODE:
                Log.i("MainActivity.clss", "地理位置权限授权成功 in activity with annotation");
                Log.d("TAG", "syncGranted:  地理位置权限授权成功 in activity with annotation");
                break;
            case SENSORS_CODE:
                Log.i("MainActivity.clss", "传感器权限授权成功 in activity with annotation");
                Log.d("TAG", "syncGranted:  传感器权限授权成功 in activity with annotation");
                break;
            case CALENDAR_CODE:
                Log.i("MainActivity.clss", "读取日历权限授权成功 in activity with annotation");
    ...
    public void syncDenied(int code) {
        switch (code) {
            case LOCATION_CODE:
                Log.i("MainActivity.clss", "地理位置权限授权失败 in activity with annotation");
                Log.d("TAG", "syncDenied:  地理位置权限授权失败 in activity with annotation");
                break;
            case SENSORS_CODE:
                Log.i("MainActivity.clss", "传感器权限授权失败 in activity with annotation");
                Log.d("TAG", "syncDenied:  传感器权限授权失败 in activity with annotation");
                break;
            case CALENDAR_CODE:
                Log.i("MainActivity.clss", "读取日历权限授权失败 in activity with annotation");
    ...
    public void syncRationale(int code) {
        switch (code) {
            case LOCATION_CODE:
                Log.i("MainActivity.clss", "请开启地理位置权限 in activity with annotation");
                Log.d("TAG", "syncRationale:  请开启地理位置权限 in activity with annotation");
                break;
            case SENSORS_CODE:
                Log.i("MainActivity.clss", "请开启传感器权限 in activity with annotation");
                Log.d("TAG", "syncRationale:  请开启传感器权限 in activity with annotation");
                break;
            case CALENDAR_CODE:
                Log.i("MainActivity.clss", "请开启读取日历权限 in activity with annotation");
    ...
    public void storageAndCallGranted() {
        Log.i("MainActivity.clss", "读取通话记录权限授权成功 in activity with annotation");
    }

    @PermissionsDenied(CALL_LOG_CODE)
    public void storageAndCallDenied() {
        Log.i("MainActivity.clss", "读取通话记录权限授权失败 in activity with annotation");
    }

    @PermissionsRationale(CALL_LOG_CODE)
    public void storageAndCallNonRationale() {
        Log.i("MainActivity.clss", "请开启读取通话记录权限授权 in activity with annotation");
    }

    //====================================================================
    @PermissionsGranted(AUDIO_CODE)
    public void smsAndAudioGranted() {
        Log.i("MainActivity.clss", "录音权限申请成功 in activity with annotation");
        Log.i("MainActivity.clss", "录音权限申请成功 in activity with annotation");
    }

    @PermissionsDenied(AUDIO_CODE)
    public void smsAndAudioDenied() {
        Log.i("MainActivity.clss", "录音权限申请失败 in activity with annotation");
    }
